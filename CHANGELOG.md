...
- GitOps workflows: pull-request plan preview, merge-to-apply, manual destroy, and hourly TTL cleanup, each using its own least-privilege vended identity via OIDC.
